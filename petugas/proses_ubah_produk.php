...
if($_POST){
    ...
    if(empty($nama_produk)){
        ...
        echo "<script>alert('foto_produk tidak boleh kosong');location.href='tambah_produk.php';</script>";
    } else {
        include "connection.php";
            $update=mysqli_query($connection,"update produk set nama_produk='".$nama_produk."',deskripsi='".$deskripsi."', harga='".$harga."', foto_produk='".$foto_produk."'") or die(mysqli_error($connection));
            if($update){
